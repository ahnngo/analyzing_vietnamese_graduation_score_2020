...
# calculate percentage of each take_exam component
for i in range(0,11):
    take_exam_percentage[i] = round((take_exam[i] / total_student * 100),2)
...
plt.bar(y_pos, take_exam_percentage, align='center', alpha=0.5)
...
plt.title('The numbers of student participating in each exam')
